/**
 * Capacity Services - Application Layer Export
 *
...
/**
 * Capacity Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for capacity domain.
 */
