/**
 * Escalations Services - Application Layer Export
 *
...
/**
 * Escalations Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for escalations domain.
 */
