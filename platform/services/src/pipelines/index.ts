/**
 * Pipelines Services - Application Layer Export
 *
...
/**
 * Pipelines Services - Application Layer
 *
 * DDD: Application use cases, ports, DTOs, policies, and errors for pipelines domain.
 */
