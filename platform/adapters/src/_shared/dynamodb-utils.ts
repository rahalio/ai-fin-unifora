 ...
 *
 * @returns The core table name (e.g., "unifora-core-dev")
 ...
 *
 * @returns The base table name (e.g., "unifora-base-dev")
 ...
 *
 * @returns The analytics table name (e.g., "unifora-analytics-dev")
 ...
 *
 * @returns The realtime table name (e.g., "unifora-app-realtime-dev")
